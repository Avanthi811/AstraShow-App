...
const TrailersSection = () => {
    const [currentTrailer, setCurrentTrailer] = useState(dummyTrailers[4] || {});
  return (
    <div className="px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden">
      <p className="text-gray-300 font-medium  text-lg  max-w-[960px] mx-auto">Trailers</p>
      <div className="relative mt-6 ">
        <BlurCircle top="-100px" right="-100px" />
        <iframe key={currentTrailer.videoUrl} src={currentTrailer.videoUrl} controls={false} className="mx-auto max-w-full rounded-xl" width="960px" height="540px"allow="autoplay; encrypted-media"
          allowFullScreen></iframe>
      </div>
        <div className="group grid grid-cols-1 gap-4 md:grid-cols-4 gap-8  mt-8 max-w-3xl mx-auto">
